...
<div class="return">
  <a href="{{route('manageEmployee', ['id'=>$employment_bond])}}" class="text-gray-500 font-bold m-2 hover:text-blue-800"> <i class="fa-solid fa-arrow-left"></i> Voltar</a>
</div>
...
<section class="section main-section">
  ...
  <div class="mb-5">
    <p><strong>Servidor:</strong> {{$employment_bond->employee->name}}</p>
    <p><strong>Data de Nascimento:</strong> {{$employment_bond->employee->date_birth->format('d/m/Y')}}</p>
    <p><strong>Matrícula:</strong> {{$employment_bond->registration}}</p>
    <p><strong>Cargo:</strong> {{$employment_bond->post}}</p>
  </div>
  ...
  <div>
    <form method="POST" action="{{route($route)}}" class="w-96">
      ...
      <div class="field">
        <label class="label">Nova Função</label>
        <div class="field-body">
          <div class="field">
            <div class="control icons-left">
              <input 
